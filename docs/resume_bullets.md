...
> Built an end-to-end clinical trial analytics pipeline over 500 Phase III patients and 3,000 unstructured clinical notes, engineering an NLP adverse-event classifier (SpaCy preprocessing/NER, TF-IDF, Logistic Regression) that achieved 92.2% accuracy (F1=0.85) and recovered 100% of adverse events missed by manual case-report-form coding, with SHAP-based global and local explainability and statistical validation (Welch's t-test, chi-square, Cohen's d, Kruskal-Wallis, all p<0.001).
